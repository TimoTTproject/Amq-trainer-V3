...
function openIdleCharacterSheet(character){
  ...
  // Le passif varie maintenant par personnage (magnitude tirée dans une
  // fourchette par palier de rareté) : plus de texte à pourcentage fixe ici,
  // la description vient toujours du serveur (`c.passive`).
