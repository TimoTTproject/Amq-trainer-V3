...
// Emblèmes de licence en SVG « icône » (dessins vectoriels propres et
// reconnaissables). On N'UTILISE PLUS les images scrapées de /official/*
// (photos/screens recadrés, illisibles en petit — cf. la « Poké Ball » qui
// montrait une grille au lieu d'une icône).
const ANIME_EMOTES = [
  ...
  { id: 'emote-jujutsu-kaisen', name: 'Jujutsu Kaisen · Six Yeux', symbol: '👁️', imageUrl: '/assets/emotes/jujutsu.svg', price: 220 },
  ...
  { id: 'emote-sao', name: 'Sword Art Online · Elucidator', symbol: '⚔️', imageUrl: '/assets/emotes/sao-swords.svg', price: 180 },
  { id: 'emote-chainsaw-man', name: 'Chainsaw Man · Pochita', symbol: '🪚', imageUrl: '/assets/emotes/chainsaw.svg', price: 220 },
  ...
  { id: 'emote-one-punch', name: 'One Punch Man · Saitama', symbol: '👊', imageUrl: '/assets/emotes/one-punch.svg', price: 180 },
  { id: 'emote-spy-family', name: 'Spy × Family · Chimère', symbol: '🕵️', imageUrl: '/assets/emotes/chimera.svg', price: 180 },
  { id: 'emote-tokyo-ghoul', name: 'Tokyo Ghoul · Kaneki', symbol: '👺', imageUrl: '/assets/emotes/ghoul-mask.svg', price: 220 },
  ...
  { id: 'emote-frieren', name: 'Frieren · Mage', symbol: '🪄', imageUrl: '/assets/emotes/frieren-staff.svg', price: 180 },
  { id: 'emote-solo-leveling', name: 'Solo Leveling · Dague de Kamish', symbol: '🗡️', imageUrl: '/assets/emotes/solo-dagger.svg', price: 220 },
  { id: 'emote-haikyuu', name: 'Haikyuu!! · Volley', symbol: '🏐', imageUrl: '/assets/emotes/haikyuu-ball.svg', price: 180 },
  { id: 'emote-blue-lock', name: 'Blue Lock · Projet', symbol: '⚽', imageUrl: '/assets/emotes/blue-lock.svg', price: 220 },
  { id: 'emote-oshi-no-ko', name: 'Oshi no Ko · Ai', symbol: '⭐', imageUrl: '/assets/emotes/star-eye.svg', price: 220 },
  { id: 'emote-bocchi', name: 'Bocchi the Rock! · Bocchi', symbol: '🎸', imageUrl: '/assets/emotes/bocchi-guitar.svg', price: 180 },
