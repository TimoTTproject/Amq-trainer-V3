...
const ANIME_EMOTES = [
  { id: 'emote-one-piece', name: 'One Piece · Jolly Roger', symbol: '☠️', imageUrl: '/assets/emotes/official/one-piece.png', price: 180 },
  { id: 'emote-naruto', name: 'Naruto · Sharingan', symbol: '🔴', imageUrl: '/assets/emotes/official/sharingan.png', price: 180 },
  { id: 'emote-dragon-ball', name: 'Dragon Ball · 4 étoiles', symbol: '🟠', imageUrl: '/assets/emotes/official/dragon-ball.png', price: 220 },
  { id: 'emote-aot', name: "L’Attaque des Titans · Bataillon", symbol: '🪽', imageUrl: '/assets/emotes/official/aot.png', price: 220 },
  { id: 'emote-demon-slayer', name: 'Demon Slayer · Hanafuda', symbol: '🎴', imageUrl: '/assets/emotes/hanafuda.svg', price: 220 },
  { id: 'emote-jujutsu-kaisen', name: 'Jujutsu Kaisen · Six Yeux', symbol: '👁️', imageUrl: '/assets/emotes/official/jujutsu.png', price: 220 },
  { id: 'emote-fullmetal', name: 'Fullmetal Alchemist · Transmutation', symbol: '⚗️', imageUrl: '/assets/emotes/official/transmutation.png', price: 180 },
  { id: 'emote-death-note', name: 'Death Note · Carnet', symbol: '📓', imageUrl: '/assets/emotes/official/death-note.jpg', price: 180 },
  { id: 'emote-bleach', name: 'Bleach · Badge Shinigami', symbol: '💀', imageUrl: '/assets/emotes/official/bleach.png', price: 180 },
  { id: 'emote-hunter', name: 'Hunter × Hunter · Licence', symbol: '♠️', imageUrl: '/assets/emotes/official/hunter.png', price: 180 },
  { id: 'emote-sao', name: 'Sword Art Online · Elucidator', symbol: '⚔️', imageUrl: '/assets/emotes/official/sao.png', price: 180 },
  { id: 'emote-chainsaw-man', name: 'Chainsaw Man · Pochita', symbol: '🪚', imageUrl: '/assets/emotes/official/chainsaw.png', price: 220 },
  { id: 'emote-pokemon', name: 'Pokémon · Poké Ball', symbol: '🔴⚪', imageUrl: '/assets/emotes/official/pokeball.png', price: 220 },
  { id: 'emote-sailor-moon', name: 'Sailor Moon · Broche lunaire', symbol: '🌙', imageUrl: '/assets/emotes/official/sailor.jpg', price: 180 },
  { id: 'emote-code-geass', name: 'Code Geass · Geass', symbol: '♟️', imageUrl: '/assets/emotes/official/geass.jpg', price: 180 },
  { id: 'emote-steins-gate', name: 'Steins;Gate · Divergence', symbol: '⌛', imageUrl: '/assets/emotes/official/divergence.png', price: 180 },
  { id: 'emote-my-hero', name: 'My Hero Academia · U.A.', symbol: '🦸', imageUrl: '/assets/emotes/official/mha.png', price: 180 },
  { id: 'emote-one-punch', name: 'One Punch Man · Saitama', symbol: '👊', imageUrl: '/assets/emotes/official/opm.png', price: 180 },
  { id: 'emote-spy-family', name: 'Spy × Family · Chimère', symbol: '🕵️', imageUrl: '/assets/emotes/chimera.svg', price: 180 },
  { id: 'emote-tokyo-ghoul', name: 'Tokyo Ghoul · Kaneki', symbol: '👺', imageUrl: '/assets/emotes/official/ghoul.png', price: 220 },
  { id: 'emote-evangelion', name: 'Evangelion · NERV', symbol: '🍂', imageUrl: '/assets/emotes/official/nerv.png', price: 220 },
  { id: 'emote-black-clover', name: 'Black Clover · Grimoire', symbol: '🍀', imageUrl: '/assets/emotes/black-clover.svg', price: 180 },
  { id: 'emote-frieren', name: 'Frieren · Mage', symbol: '🪄', imageUrl: '/assets/emotes/official/frieren.png', price: 180 },
  { id: 'emote-solo-leveling', name: 'Solo Leveling · Dague de Kamish', symbol: '🗡️', imageUrl: '/assets/emotes/official/solo.jpg', price: 220 },
  { id: 'emote-haikyuu', name: 'Haikyuu!! · Volley', symbol: '🏐', imageUrl: '/assets/emotes/haikyuu-ball.svg', price: 180 },
  { id: 'emote-blue-lock', name: 'Blue Lock · Projet', symbol: '⚽', imageUrl: '/assets/emotes/official/blue-lock.jpg', price: 220 },
  { id: 'emote-oshi-no-ko', name: 'Oshi no Ko · Ai', symbol: '⭐', imageUrl: '/assets/emotes/official/oshi.png', price: 220 },
  { id: 'emote-bocchi', name: 'Bocchi the Rock! · Bocchi', symbol: '🎸', imageUrl: '/assets/emotes/official/bocchi.png', price: 180 },
  { id: 'emote-jojo', name: 'JoJo · Masque de pierre', symbol: '🗿', imageUrl: '/assets/emotes/official/jojo.png', price: 220 },
  { id: 'emote-fairy-tail', name: 'Fairy Tail · Guilde', symbol: '🔥', imageUrl: '/assets/emotes/official/fairy.png', price: 180 },
